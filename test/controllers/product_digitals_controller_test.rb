...
class ProductDigitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_digital" do
    assert_difference('ProductDigital.count') do
      post product_digitals_url, params: { product_digital: { description: @product_digital.description, name: @product_digital.name, price: @product_digital.price, sku: @product_digital.sku, stock: @product_digital.stock } }
    end
  ...
  test "should update product_digital" do
    patch product_digital_url(@product_digital), params: { product_digital: { description: @product_digital.description, name: @product_digital.name, price: @product_digital.price, sku: @product_digital.sku, stock: @product_digital.stock } }
